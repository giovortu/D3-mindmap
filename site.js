...
(function($){
    ...
    var that = {
      ...
      switchSection:function(newSection){
        ...
        sys.eachNode(function(node){
          if (node.data.shape=='circle') return // skip all but leafnodes
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          clicked:function(e){
            ...
            if (nearest.node.data.shape!='circle')
            {
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"arbor.js":{color:"red", shape:"circle", alpha:1}, 
      
             demos:{color:CLR.branch, shape:"circle", alpha:1}, 
             ...
             docs:{color:CLR.branch, shape:"circle", alpha:1}, 
             
             reference:{color:CLR.doc, alpha:0, link:'#reference'},
             
             introduction:{color:CLR.doc, alpha:0, link:'#introduction'},
             
             gio:{color:CLR.branch, shape:"circle", alpha:1},
             
             pippo:{color:CLR.branch,  alpha:0, link:'https://github.com/samizdatco/f'},
             
             ciccio:{color:CLR.code, alpha:0, link:'https://github.com/samizdatco/a'},
             
            gio2:{color:CLR.branch, shape:"circle", alpha:1},
             
             pippo2:{color:CLR.branch,  alpha:0, link:'https://github.com/samizdatco/f'},
             
             ciccio2:{color:CLR.code, alpha:0, link:'https://github.com/samizdatco/a'},

             code:{color:CLR.branch, shape:"circle", alpha:1},
